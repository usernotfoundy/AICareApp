...
export default function GetStarted3({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Pressable style={styles.setButtonStyle} onPress={() => navigation.navigate('Login')}>
                <Text style={styles.setRegularText}>Get Started</Text>
            </Pressable>
